(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('@covalent/markdown', ['exports', '@angular/core', '@angular/platform-browser', '@angular/common'], factory) :
	(factory((global.covalent = global.covalent || {}, global.covalent.markdown = {}),global.ng.core,global.ng.platformBrowser,global.ng.common));
...
var TdMarkdownComponent = /** @class */ (function () {
    ...
    TdMarkdownComponent.prototype._elementFromString = function (markupStr) {
        ...
        div.innerHTML = this._domSanitizer.sanitize(core.SecurityContext.HTML, markupStr);
        return div;
    };
...
CovalentMarkdownModule.ctorParameters = function () { return []; };
