(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/cdk/coercion'), require('@angular/cdk/bidi'), require('@angular/common'), require('@angular/material/icon'), require('@angular/material/button'), require('@angular/cdk/portal'), require('@angular/platform-browser'), require('@angular/animations'), require('@angular/forms'), require('@angular/router'), require('rxjs/operators'), require('rxjs'), require('@covalent/core/common'), require('@angular/cdk/keycodes'), require('@angular/material/chips'), require('@angular/material/input'), require('@angular/material/core'), require('@angular/material/autocomplete'), require('@angular/material/checkbox'), require('@angular/material/tooltip'), require('@angular/material/dialog'), require('@angular/material/sidenav'), require('@angular/cdk/scrolling'), require('@angular/material/toolbar'), require('@angular/material/card'), require('@angular/material/divider'), require('@angular/cdk/overlay'), require('@angular/material/progress-bar'), require('@angular/material/progress-spinner'), require('@angular/material/menu')) :
	typeof define === 'function' && define.amd ? define('@covalent/core', ['exports', '@angular/core', '@angular/cdk/coercion', '@angular/cdk/bidi', '@angular/common', '@angular/material/icon', '@angular/material/button', '@angular/cdk/portal', '@angular/platform-browser', '@angular/animations', '@angular/forms', '@angular/router', 'rxjs/operators', 'rxjs', '@covalent/core/common', '@angular/cdk/keycodes', '@angular/material/chips', '@angular/material/input', '@angular/material/core', '@angular/material/autocomplete', '@angular/material/checkbox', '@angular/material/tooltip', '@angular/material/dialog', '@angular/material/sidenav', '@angular/cdk/scrolling', '@angular/material/toolbar', '@angular/material/card', '@angular/material/divider', '@angular/cdk/overlay', '@angular/material/progress-bar', '@angular/material/progress-spinner', '@angular/material/menu'], factory) :
	(factory((global.covalent = global.covalent || {}, global.covalent.core = {}),global.ng.core,global.ng.cdk.coercion,global.ng.cdk.bidi,global.ng.common,global.ng.material.icon,global.ng.material.button,global.ng.cdk.portal,global.ng.platformBrowser,global.ng.animations,global.ng.forms,global.ng.router,global.Rx.Observable.prototype,global.rxjs,global.covalent.core.common,global.ng.cdk.keycodes,global.ng.material.chips,global.ng.material.input,global.ng.material.core,global.ng.material.autocomplete,global.ng.material.checkbox,global.ng.material.tooltip,global.ng.material.dialog,global.ng.material.sidenav,global.ng.cdk.scrolling,global.ng.material.toolbar,global.ng.material.card,global.ng.material.divider,global.ng.cdk.overlay,global.ng.material['progress-bar'],global.ng.material['progress-spinner'],global.ng.material.menu));
}(this, (function (exports,core,coercion,bidi,common,icon,button,portal,platformBrowser,animations,forms,router,operators,rxjs,common$1,keycodes,chips,input,core$1,autocomplete,checkbox,tooltip,dialog,sidenav,scrolling,toolbar,card,divider,overlay,progressBar,progressSpinner,menu) { 'use strict';
...
var TdMediaService = /** @class */ (function () {
    ...
    TdMediaService.prototype.registerQuery = function (query$$1) {
        ...
        if (!this._querySources[query$$1]) {
            this._querySources[query$$1] = new rxjs.BehaviorSubject(matchMedia(query$$1).matches);
